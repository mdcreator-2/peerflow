      ...
      <div className="max-w-lg mx-auto px-4 sm:px-6 lg: px-8">
          ...
          <div className="p-6">
            ...
            {deliveryPin && (
              <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <p className="text-2xl font-mono font-bold text-blue-700 text-center">
                  {deliveryPin}
                </p>
                <p className="text-xs text-blue-600 mt-2 text-center">
                  Share this PIN with the seller during meetup to verify your
                  identity
                </p>
              </div>
            )}
        ...
        <div className="mt-6 p-4 bg-white rounded-xl shadow-sm">
          ...
          <ol className="text-sm text-gray-600 space-y-2">
            <li className="flex items-start gap-2">
              <span className="bg-primary-100 text-primary-700 rounded-full w-5 h-5 flex items-center justify-center text-xs font-medium flex-shrink-0">
                1
              </span>
              <span>
                After payment, contact the seller to arrange a meetup on campus
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="bg-primary-100 text-primary-700 rounded-full w-5 h-5 flex items-center justify-center text-xs font-medium flex-shrink-0">
              ...
              <span>Meet the seller and collect your item</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="bg-primary-100 text-primary-700 rounded-full w-5 h-5 flex items-center justify-center text-xs font-medium flex-shrink-0">
                3
              </span>
              <span>The seller will mark the item as "Handed Over"</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="bg-primary-100 text-primary-700 rounded-full w-5 h-5 flex items-center justify-center text-xs font-medium flex-shrink-0">
                4
        ...
        <div className="mt-6 text-center">
          <div className="flex items-center justify-center space-x-2 text-sm text-gray-500">
            ...
            <span>Secure payment powered by PeerFlow</span>
          </div>
        </div>
      </div>
    </div>
